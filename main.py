...
if __name__ == "__main__":
    ...
    for iteration in range (0,1):
        for G_name in G_names_list : 
            ...
            #gp.analyze_commus_greels(G_name_short="G_reels", nb_iterations=0, spatial_ref = "GT_pos", i_min =0.00, i_max = 1.00, nb_i=11, name_export_results="2026_05_11")import src.SHAP_like_graph_tool as gpimport src.SHAP_like_graph_tool as gp
import src.SHAP_like_graph_tool.utils as gput
...
if __name__ == "__main__":
    ...
    for iteration in range (0,1):
        for G_name in G_names_list : 
            ...
            #gp.analyze_commus_greels(G_name_short="G_reels", nb_iterations=0, spatial_ref = "GT_pos", i_min =0.00, i_max = 1.00, nb_i=11, name_export_results="2026_05_11")import src.SHAP_like_graph_tool as gp