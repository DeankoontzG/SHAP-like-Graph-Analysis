...
if __name__ == "__main__":
    ...
    start_time = time.time()
    all_results = gp.analyze_commus(G_name_short = "artificial_graph_sbmv_4_orthoModulo", nb_iterations=10, spatial_ref = "GT_pos", i_min = 0.00, i_max = 1.00, nb_i=11, name_export_results="")
    end_time = time.time()
    duration = end_time - start_time
    print("\n" + "="*50)
    print("📊 TEMPS D'EXEC POUR ANALYSIS PAS HALAL :")
    print("="*50)
    print(f"{duration} secs")import src.SHAP_like_graph_tool as gp
import src.SHAP_like_graph_tool.utils as gput
