...
def analyze_commus(G_name_short, nb_iterations, spatial_ref = "GT_pos", i_min =0.00, i_max = 1.00, nb_i=11, name_export_results="DATE"):
    ...
    features_orthoModulo_posEig_emb = ["orthoModulo_posEig_dist"]
    features_orthoModulo_posEig_nonDC_emb = ["orthoModulo_posEig_nonDC_dist"]
    features_orthoModulo_baseline_emb = ["orthoModulo_baseline_dist"]
    features_deepwalk = ["deepwalk_dist"]
    features_orthoModulo_posEig_comu = ["orthoModulo_posEig_density"]
    features_orthoModulo_posEig_nonDC_comu = ["orthoModulo_posEig_nonDC_density"]
    features_louvain = ["orthoModulo_baseline_density"]
    ...
    experiments = {
        "orthoModulo_posEig_emb": features_orthoModulo_posEig_emb,
        "orthoModulo_posEig_nonDC_emb": features_orthoModulo_posEig_nonDC_emb,
        "orthoModulo_baseline_emb": features_orthoModulo_baseline_emb,
        "deepwalk_baseline_emb": features_deepwalk,
        "orthoModulo_posEig_comu": features_orthoModulo_posEig_comu,
        "orthoModulo_posEig_nonDC_comu": features_orthoModulo_posEig_nonDC_comu,
        "louvain_baseline_comu": features_louvain,
        "orthoModulo_posEig": features_orthoModulo_posEig_comu + features_orthoModulo_posEig_emb,
        "orthoModulo_posEig_nonDC": features_orthoModulo_posEig_nonDC_comu + features_orthoModulo_posEig_nonDC_emb,
        "orthoModulo_baseline": features_louvain + features_orthoModulo_baseline_emb,
        "deepwalk_louvain_baseline": features_deepwalk + features_louvain,
    }
...
def run_single_experiment_greels(nb_iter, i, spatial_ref, G_name_short, experiments):
        ...
        return local_resultsfrom .utils import *
from .models import *
import matplotlib.pyplot as plt
import numpy as np
import pandas as pd
